...
import { Menu, Plus, Package, ClipboardList, GraduationCap, Star, Bell, Settings, MessageCircle } from 'lucide-react-native';
import '../../global.css';
...
export default function MenuScreen() {
  ...
  const menuItems = [
    { id: '1', title: 'Create New', icon: Plus, route: '/(seller)/create-new' },
    { id: '2', title: 'Stock', icon: Package, route: '/(seller)/stock' },
    { id: '3', title: 'Orders', icon: ClipboardList, route: '/(seller)/orders' },
    { id: '4', title: 'EduHub', icon: GraduationCap, route: '/(seller)/eduhub' },
    { id: '5', title: 'Achievements & Badges', icon: Star, route: '/(seller)/rewards' },
    { id: '6', title: 'Notifications', icon: Bell, route: '/(seller)/notifications' },
  ];
